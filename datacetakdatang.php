<h2 align="center">Data Penduduk Datang Kelurahan Kebon Pedes</h2>
<div class="row">
  <div class="col-md-12">
    <div class="btn-group">
          ...
          <tbody>
            <?php
              ...
              <tr>
                ...
                <td align="center">
                  <?php 
                    $data_laki_laki = mysql_query("select * from data_datang where jenis_kelamin='Laki-Laki' && kelurahan='$d[nama_rw]'");
                ...
                <td align="center">
                  <?php 
                    $data_perempuan = mysql_query("select * from data_datang where jenis_kelamin='Perempuan' && kelurahan='$d[nama_rw]'");
                ...
                <td align="center">
                  <?php 
                    $data_all = mysql_query("select * from data_datang where kelurahan='$d[nama_rw]'");
